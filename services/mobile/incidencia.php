            ...
            if(pg_num_rows($consulta_p)>0){
                ...
                if(pg_num_rows($consulta_r)>0){
                    foreach ($consulta_r as $cr){
                        ...
                        $consulta_empre = pg_fetch_all(pg_query($conexion_bd, $sql_empre));
                        if(pg_num_rows($consulta_empre)>0){
                        ...
                        $consulta_pr = pg_fetch_all(pg_query($conexion_bd, $sql_pr));
                        
                        $nro = 0;
                        if(pg_num_rows($consulta_pr)>0){
                        ...
                        if ($parada_empresa_pendiente == '1'){
                            ...
                            $consulta_pr_r = pg_fetch_all(pg_query($conexion_bd, $sql_pr_r));

                            if(pg_num_rows($consulta_pr_r)>0){
                                foreach ($consulta_pr_r as $prr){
                                    ...
                                    pg_query($conexion_bd, $sql_prr);
                                }
                            }
                            
                            AsignarChofer($nro_total, $hora, $ruta_nueva, $fecha, $edo_empre);
                        }else{
                            AsignarChofer($nro, $hora, $ruta_nueva, $fecha, $edo_empre);
                        }                     
                ...
                $consulta_r2 = pg_fetch_all(pg_query($conexion_bd, $sql_r2));
                if(pg_num_rows($consulta_r2)>0){
                    foreach ($consulta_r2 as $cr2){
                        ...
                        $consulta_p_r2 = pg_fetch_all(pg_query($conexion_bd, $sql_p_r2));
